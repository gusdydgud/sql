...
--TRUNC 절삭
SELECT TRUNC(45.923),TRUNC(45.932,0),TRUNC(45.923,2),TRUNC(45.923,-1) FROM DUAL;
--ABS 정대값
--CEIL 올림
--FLOOR내림
...
SELECT FIRST_NAME, (SYSDATE -HIRE_DATE)/7 FROM EMPLOYEES; --입사한지 몇주
SELECT FIRST_NAME, (SYSDATE - HIRE_DATE)/365 FROM EMPLOYEES; --입사한지 몇년
